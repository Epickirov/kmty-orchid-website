...
en: {
  ...
  'c.ph':'Your work email','c.prf':'Shipping to','c.prfm':'Korea · Vietnam · Philippines · Thailand · Singapore · Dubai · Oman · Brunei · Hong Kong','c.prfr':'Ranked China’s №1 exporter of flowering Phalaenopsis by customs data — every year since 2020.','c.addr':'Xiaojie, Songming County, Kunming','c.langs':'EN · 中文 · РУ · VI',
...
zh: {
  ...
  'c.ph':'您的工作邮箱','c.prf':'出口市场','c.prfm':'韩国 · 越南 · 菲律宾 · 泰国 · 新加坡 · 迪拜 · 阿曼 · 文莱 · 香港','c.prfr':'海关数据认证：自 2020 年起，连年位居中国开花蝴蝶兰出口第一。','c.addr':'云南省昆明市嵩明县小街','c.langs':'EN · 中文 · РУ · VI',
...
ru: {
  ...
  'c.ph':'Ваш рабочий e-mail','c.prf':'Поставляем в','c.prfm':'Корея · Вьетнам · Филиппины · Таиланд · Сингапур · Дубай · Оман · Бруней · Гонконг','c.prfr':'По таможенным данным — экспортёр №1 цветущих фаленопсисов Китая, каждый год с 2020-го.','c.addr':'Сяоцзе, уезд Сунмин, Куньмин','c.langs':'EN · 中文 · РУ · VI',
...
vi: {
  ...
  'c.ph':'Email công việc của bạn','c.prf':'Xuất khẩu đến','c.prfm':'Hàn Quốc · Việt Nam · Philippines · Thái Lan · Singapore · Dubai · Oman · Brunei · Hồng Kông','c.prfr':'Theo dữ liệu hải quan — nhà xuất khẩu hồ điệp nở hoa số 1 Trung Quốc, liên tục từ 2020.','c.addr':'Tiểu Nhai, huyện Tùng Minh, Côn Minh','c.langs':'EN · 中文 · РУ · VI',
