...
zh: {
  ...
  'mix.eyebrow':'亲手试一试','mix.h':'调一支你的星空。','mix.sub':'最多选三种颜色，调好比例，再搅一次 — 每一次的纹理都不一样，正如真正的艺术兰。','mix.colors':'颜色 · 最多 3 种','mix.balance':'比例','mix.again':'再搅一次','mix.save':'保存这支配色','mix.disc':'仅供参考。每一株星空艺术兰均为手工制作，实物可能与预览图有所差异。','mix.order':'订购这支配色','mix.caption':'你的独一无二',
...
vi: {
  ...
  'mix.eyebrow':'Tự tay thử','mix.h':'Pha màu của riêng bạn.','mix.sub':'Chọn tối đa ba màu, chỉnh tỷ lệ rồi xoáy — mỗi lần vân màu lại khác, như chính những đóa thật.','mix.colors':'Màu sắc · tối đa 3','mix.balance':'Tỷ lệ','mix.again':'Xoáy lại','mix.save':'Lưu phối màu này','mix.disc':'Chỉ mang tính tham khảo. Mỗi đóa lan Constellation đều được làm thủ công — cây thực tế có thể khác với bản xem trước.','mix.order':'Đặt mua phối màu này','mix.caption':'Độc bản của bạn',
