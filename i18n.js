...
zh: {
  ...
  'c.ph':'您的工作邮箱','c.phco':'公司名称','c.phnm':'联系人','c.phtel':'电话 / WhatsApp','c.phmsg':'您的需求（品种、数量、目的地……）','c.prf':'出口市场','c.prfm':'韩国 · 越南 · 菲律宾 · 泰国 · 新加坡 · 迪拜 · 阿曼 · 文莱 · 香港','c.prfr':'海关数据认证：自 2020 年起，连年位居中国开花蝴蝶兰出口第一。','c.addr':'云南省昆明市嵩明县小街','c.langs':'EN · 中文 · РУ · VI',
...
vi: {
  ...
  'c.ph':'Email công việc của bạn','c.phco':'Tên công ty','c.phnm':'Người liên hệ','c.phtel':'Số điện thoại / WhatsApp','c.phmsg':'Bạn đang tìm gì? (giống, số lượng, điểm đến…)','c.prf':'Xuất khẩu đến','c.prfm':'Hàn Quốc · Việt Nam · Philippines · Thái Lan · Singapore · Dubai · Oman · Brunei · Hồng Kông','c.prfr':'Theo dữ liệu hải quan — nhà xuất khẩu hồ điệp nở hoa số 1 Trung Quốc, liên tục từ 2020.','c.addr':'Tiểu Nhai, huyện Tùng Minh, Côn Minh','c.langs':'EN · 中文 · РУ · VI',
