...
en: {
  ...
  'mix.eyebrow':'Try the bench','mix.h':'Mix your own.','mix.sub':'Pick up to three colours, set the balance, and swirl — every pour lands differently, exactly like the living ones.','mix.colors':'Colours · up to 3','mix.balance':'Balance','mix.again':'Swirl again','mix.save':'Save this mix','mix.order':'Order this mix','mix.caption':'Your one-of-one',
...
zh: {
  ...
  'mix.eyebrow':'亲手试一试','mix.h':'调一支你的星空。','mix.sub':'最多选三种颜色，调好比例，再搅一次 — 每一次的纹理都不一样，正如真正的艺术兰。','mix.colors':'颜色 · 最多 3 种','mix.balance':'比例','mix.again':'再搅一次','mix.save':'保存这支配色','mix.order':'订购这支配色','mix.caption':'你的独一无二',
...
ru: {
  ...
  'mix.eyebrow':'Попробуйте сами','mix.h':'Смешайте свой.','mix.sub':'Выберите до трёх цветов, задайте пропорции и закрутите — каждый раз узор ложится по-новому, как на живых цветках.','mix.colors':'Цвета · до 3','mix.balance':'Баланс','mix.again':'Закрутить ещё','mix.save':'Сохранить смесь','mix.order':'Заказать эту смесь','mix.caption':'Ваш единственный',
...
vi: {
  ...
  'mix.eyebrow':'Tự tay thử','mix.h':'Pha màu của riêng bạn.','mix.sub':'Chọn tối đa ba màu, chỉnh tỷ lệ rồi xoáy — mỗi lần vân màu lại khác, như chính những đóa thật.','mix.colors':'Màu sắc · tối đa 3','mix.balance':'Tỷ lệ','mix.again':'Xoáy lại','mix.save':'Lưu phối màu này','mix.order':'Đặt mua phối màu này','mix.caption':'Độc bản của bạn',
