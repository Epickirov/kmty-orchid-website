...
en: {
  ...
  'hero.art':'✦ The Art Orchid','hero.s1':'flowering-orchid exporter, China','hero.s2':'of national export share','hero.s3':'product lines · seedling→cut','hero.s4':'established in Yunnan',
...
zh: {
  ...
  'hero.art':'✦ 艺术兰','hero.s1':'中国开花蝴蝶兰出口商','hero.s2':'全国出口份额占比','hero.s3':'产品线 · 从种苗到切花','hero.s4':'创立于云南',
  'hero.mkts':'出口市场',
  ...
  'mix.eyebrow':'亲手试一试','mix.h':'调一支你的星空。','mix.sub':'最多选三种颜色，调好比例，再搅一次 — 每一次的纹理都不一样，正如真正的艺术兰。','mix.colors':'颜色 · 最多 3 种','mix.balance':'比例','mix.again':'再搅一次','mix.save':'保存这支配色','mix.disc':'仅供参考。每一株星空艺术兰均为手工制作，实物与花色设计可能与预览图有所差异。','mix.order':'订购这支配色','mix.caption':'你的独一无二','mix.savehint':'长按上方图片，选择「保存图片」即可存入相册。',
...
ru: {
  ...
  'hero.art':'✦ Арт-орхидея','hero.s1':'экспортёр цветущих орхидей в Китае','hero.s2':'национального экспорта','hero.s3':'линейки · от сеянца до среза','hero.s4':'основаны в Юньнани',
...
vi: {
  ...
  'hero.art':'✦ Lan nghệ thuật','hero.s1':'xuất khẩu hồ điệp nở hoa, Trung Quốc','hero.s2':'thị phần xuất khẩu cả nước','hero.s3':'dòng sản phẩm · cây giống→cắt cành','hero.s4':'thành lập tại Vân Nam',
  ...
  'mix.eyebrow':'Tự tay thử','mix.h':'Pha màu của riêng bạn.','mix.sub':'Chọn tối đa ba màu, chỉnh tỷ lệ rồi xoáy — mỗi lần vân màu lại khác, như chính những đóa thật.','mix.colors':'Màu sắc · tối đa 3','mix.balance':'Tỷ lệ','mix.again':'Xoáy lại','mix.save':'Lưu phối màu này','mix.disc':'Chỉ mang tính tham khảo. Mỗi đóa lan Constellation đều được làm thủ công — cây thực tế và thiết kế màu có thể khác với bản xem trước.','mix.order':'Đặt mua phối màu này','mix.caption':'Độc bản của bạn','mix.savehint':'Nhấn giữ hình ảnh phía trên rồi chọn Lưu hình ảnh.',
